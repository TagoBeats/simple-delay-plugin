...
{
    return 60000.0 * noteLengthMultipliers[size_t(index)] / bpm;            //60000 millisec per minute, index select note length from AudioParameterChoice parameter
}
