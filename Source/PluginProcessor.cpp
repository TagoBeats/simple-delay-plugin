...
bool DelayAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
    ...
    if (mainIn == mono && mainOut == mono) { return true; }         // == prüft ob zwei values gleich sind, true wenn ja, false wenn nicht
    if (mainIn == mono && mainOut == stereo) { return true; }       // && means and, beide seiten müssen true sein um true zu bekommen
...
DelayAudioProcessor::getBypassParameter() const
{
